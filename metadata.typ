...
#let zadatak = [
     ...
     2. Анализирати постојећи процес управљања пројектом развоја видео игре
     „Fragments of the Void“, реализованим у оквиру програма „Playing Narratives“, 
     са акцентом на организацију рада тима, праћење напретка и управљање ризицима и променама.
     3. Изучити теоријске основе агилних методологија управљања пројектима.
     4. Израдити предлог унапређеног модела управљања пројектом, прилагођеног 
     специфичностима развоја видео игара.
     5. Упоредити предложени модел са постојећим процесом управљања и анализирати 
     предности и ограничења предложеног решења.
